...
function InputGroup({
    ...
    return (
        <div className="flex flex-col gap-1.5">
            ...
            {helperText && (
                <p className="text-xs text-white/30 pl-1">{helperText}</p>
            )}
        </div>
    );
}
                ...
                >
                    ...
                    <motion.div variants={heroItem} className="space-y-2">
                        <h1 className="text-4xl font-medium tracking-tight text-white whitespace-nowrap">
                            Join NeoScape Properties
                        </h1>
                        <p className="text-sm leading-relaxed text-white/60 px-4">
                            Follow these 3 quick phases to activate your property management
                            space.
                        </p>
                    </motion.div>
                ...
                >
                    ...
                    <div className="space-y-1.5">
                        ...
                        <p className="text-sm text-white/40">
                            Input your basic details to begin your NeoScape journey.
                        </p>
                    </div>
